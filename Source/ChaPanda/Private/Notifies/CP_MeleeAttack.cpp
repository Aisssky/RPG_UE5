...
void UCP_MeleeAttack::SendEventsToActors(USkeletalMeshComponent* MeshComp, const TArray<FHitResult>& Hits) const
{
    ...
    {
        ACP_PlayerCharacter* PlayerCharacter = Cast<ACP_PlayerCharacter>(Hit.GetActor());
        ...
        UAbilitySystemBlueprintLibrary::SendGameplayEventToActor(MeshComp->GetOwner(), CP_Tags::Events::Enemy::MeleeTraceHit, Payload);
    }
}
